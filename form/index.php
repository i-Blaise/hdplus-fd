...
{
   if(!empty($_POST['name']) && !empty($_POST['fathers_name']) && !empty($_POST['message']))
   {
      ...
      <div class="main-wrapper">
        ...
        <div class="right-col">
            ...
            <form id="dad-day" action="" method="post">
                <input type="name" id="fname" name="your_name" placeholder="Enter your name">
                <input type="name" id="fathers_name" name="fathers_name" placeholder="Enter your father's name">
